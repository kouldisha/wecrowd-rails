class Cardreader < ActiveRecord::Base
  ...
  #this function is for testing purposes only. It is used to locally make API calls to POS portal via the API written by Jitesh. The base URL is generated by the ngrok server used to make requests from our respective local machines. This will NOT work on production or unless the ngrok server is running.
  #when the real API is ready, the above two functions (order_cardreader and find_cardreader) will be called
